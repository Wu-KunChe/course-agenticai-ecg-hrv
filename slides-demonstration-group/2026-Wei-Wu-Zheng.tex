...
\begin{frame}{Problem Statement}
    \begin{columns}
        ...
        \begin{column}{0.35\textwidth}
            ...
            \textit{[Drowsy driver illustration]}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Three-Agent Agentic AI Architecture}
    \centering
    \textbf{Multi-Agent Pipeline Design}

    \vspace{1em}
    \begin{tabular}{ccccc}
        \fbox{\parbox{2.5cm}{\centering \textbf{Agent 1}\\Signal Filter}} &
        $\longrightarrow$ &
        \fbox{\parbox{2.5cm}{\centering \textbf{Agent 2}\\Feature Extraction}} &
        $\longrightarrow$ &
        \fbox{\parbox{2.8cm}{\centering \textbf{Agent 3}\\Decision + MCP}}
    \end{tabular}
    ...
    \begin{columns}
        ...
        \begin{column}{0.32\textwidth}
            ...
            \begin{itemize}
                ...
                \item RR interval calc.
                \item Heart Rate (HR)
                \item HRV metrics (SDNN, RMSSD)
            \end{itemize}
        \end{column}
        \begin{column}{0.32\textwidth}
            \textbf{Agent 3:}
            \begin{itemize}
                \item Multi-factor scoring
...
\begin{frame}{System Interface}
    ...
    \vspace{1em}
    % If you have a screenshot, include it:
    ...
    \begin{columns}
        \begin{column}{0.3\textwidth}
            \textbf{Left Panel:}
            \begin{itemize}
                \item Upload ECG file
                \item Set sampling rate
                \item Set driving duration
            \end{itemize}
        \end{column}
        \begin{column}{0.3\textwidth}
            \textbf{Main Area:}
    ...
    \vspace{1em}
    \textit{Demo: streamlit run app.py}
\end{frame}
